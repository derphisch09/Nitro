...
void CAutoItem::Run(CTFPlayer* pLocal)
{
	...
	if (iClass != 0)
	{
		...
		if (Vars::Misc::Automation::AutoItem::Enable.Value & Vars::Misc::Automation::AutoItem::EnableEnum::Noisemaker && pLocalInventory->GetFirstItemOfItemDef(m_iNoisemakerDefIndex))
		{
