...
{
#ifdef DEBUG_HOOKS
	if (!Vars::Hooks::Direct3DDevice9_Present[DEFAULT_BIND])
...
{
#ifdef DEBUG_HOOKS
	if (!Vars::Hooks::Direct3DDevice9_Reset[DEFAULT_BIND])
...
{
#ifdef DEBUG_HOOKS
	if (!Vars::Hooks::VGuiSurface_LockCursor[DEFAULT_BIND])
...
{
#ifdef DEBUG_HOOKS
	if (!Vars::Hooks::VGuiSurface_SetCursor[DEFAULT_BIND])
