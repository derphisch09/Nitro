...
MAKE_HOOK(CTFParty_BAnyMemberWithoutTicket, S::CTFParty_BAnyMemberWithoutTicket(), bool, void* rcx)
{
#ifdef DEBUG_HOOKS
	if (!Vars::Hooks::CTFParty_BAnyMemberWithoutTicket[DEFAULT_BIND])
