...
MAKE_HOOK(CTFParty_BAnyMemberWithoutCompetitiveAccess, S::CTFParty_BAnyMemberWithoutCompetitiveAccess(), bool, void* rcx)
{
#ifdef DEBUG_HOOKS
	if (!Vars::Hooks::CTFParty_BAnyMemberWithoutCompetitiveAccess[DEFAULT_BIND])
