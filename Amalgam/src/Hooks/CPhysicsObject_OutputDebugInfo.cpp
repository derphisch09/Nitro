...
MAKE_HOOK(CPhysicsObject_OutputDebugInfo, S::CPhysicsObject_OutputDebugInfo(), void, void* rcx)
{
    //CALL_ORIGINAL(rcx);

	//auto GetVelocity = reinterpret_cast<void(__fastcall*)(void*, Vec3*, Vec3*)>(*reinterpret_cast<uintptr_t*>(rcx) + 408);
