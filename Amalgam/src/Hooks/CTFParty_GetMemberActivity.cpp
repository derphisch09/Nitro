...
MAKE_HOOK(CTFParty_GetMemberActivity, S::CTFParty_GetMemberActivity(), void*, void* rcx, int idx)
{
#ifdef DEBUG_HOOKS
	if (!Vars::Hooks::CTFParty_GetMemberActivity[DEFAULT_BIND])
		return CALL_ORIGINAL(rcx, idx);
#endif
